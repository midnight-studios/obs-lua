...
function script_properties()
	...
	local p_34 = obs.obs_properties_add_list( props, "import_list", "<i>Settings file</i>", obs.OBS_COMBO_TYPE_LIST, obs.OBS_COMBO_FORMAT_STRING )
