...
function script_load( settings )
	...
	obs.obs_data_array_release( reset_hotkey_save_array )	
	p_h_a_1_hotkey_id = obs.obs_hotkey_register_frontend( "p_h_a_1_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_h_a_1 " .. filename(), p_h_a_1 )
	p_h_b_1_hotkey_id = obs.obs_hotkey_register_frontend( "p_h_b_1_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_h_b_1 " .. filename(), p_h_b_1 )
	p_h_c_1_hotkey_id = obs.obs_hotkey_register_frontend( "p_h_c_1_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_h_c_1 " .. filename(), p_h_c_1 )
	p_h_d_1_hotkey_id = obs.obs_hotkey_register_frontend( "p_h_d_1_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_h_d_1 " .. filename(), p_h_d_1 )
	p_h_e_1_hotkey_id = obs.obs_hotkey_register_frontend( "p_h_e_1_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_h_e_1 " .. filename(), p_h_e_1 )
	p_v_a_1_hotkey_id = obs.obs_hotkey_register_frontend( "p_v_a_1_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_v_a_1 " .. filename(), p_v_a_1 )
	p_v_b_1_hotkey_id = obs.obs_hotkey_register_frontend( "p_v_b_1_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_v_b_1 " .. filename(), p_v_b_1 )
	p_v_c_1_hotkey_id = obs.obs_hotkey_register_frontend( "p_v_c_1_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_v_c_1 " .. filename(), p_v_c_1 )
	p_v_d_1_hotkey_id = obs.obs_hotkey_register_frontend( "p_v_d_1_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_v_d_1 " .. filename(), p_v_d_1 )
	p_v_e_1_hotkey_id = obs.obs_hotkey_register_frontend( "p_v_e_1_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_v_e_1 " .. filename(), p_v_e_1 )
	p_s_a_1_hotkey_id = obs.obs_hotkey_register_frontend( "p_s_a_1_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_s_a_1 " .. filename(), p_s_a_1 )
	p_s_b_1_hotkey_id = obs.obs_hotkey_register_frontend( "p_s_b_1_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_s_b_1 " .. filename(), p_s_b_1 )
	p_s_c_1_hotkey_id = obs.obs_hotkey_register_frontend( "p_s_c_1_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_s_c_1 " .. filename(), p_s_c_1 )
	p_s_d_1_hotkey_id = obs.obs_hotkey_register_frontend( "p_s_d_1_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_s_d_1 " .. filename(), p_s_d_1 )
	p_s_e_1_hotkey_id = obs.obs_hotkey_register_frontend( "p_s_e_1_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_s_e_1 " .. filename(), p_s_e_1 )			
	p_h_a_0_hotkey_id = obs.obs_hotkey_register_frontend( "p_h_a_0_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_h_a_0 " .. filename(), p_h_a_0 )
	p_h_b_0_hotkey_id = obs.obs_hotkey_register_frontend( "p_h_b_0_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_h_b_0 " .. filename(), p_h_b_0 )
	p_h_c_0_hotkey_id = obs.obs_hotkey_register_frontend( "p_h_c_0_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_h_c_0 " .. filename(), p_h_c_0 )
	p_h_d_0_hotkey_id = obs.obs_hotkey_register_frontend( "p_h_d_0_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_h_d_0 " .. filename(), p_h_d_0 )
	p_h_e_0_hotkey_id = obs.obs_hotkey_register_frontend( "p_h_e_0_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_h_e_0 " .. filename(), p_h_e_0 )
	p_v_a_0_hotkey_id = obs.obs_hotkey_register_frontend( "p_v_a_0_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_v_a_0 " .. filename(), p_v_a_0 )
	p_v_b_0_hotkey_id = obs.obs_hotkey_register_frontend( "p_v_b_0_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_v_b_0 " .. filename(), p_v_b_0 )
	p_v_c_0_hotkey_id = obs.obs_hotkey_register_frontend( "p_v_c_0_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_v_c_0 " .. filename(), p_v_c_0 )
	p_v_d_0_hotkey_id = obs.obs_hotkey_register_frontend( "p_v_d_0_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_v_d_0 " .. filename(), p_v_d_0 )
	p_v_e_0_hotkey_id = obs.obs_hotkey_register_frontend( "p_v_e_0_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_v_e_0 " .. filename(), p_v_e_0 )
	p_s_a_0_hotkey_id = obs.obs_hotkey_register_frontend( "p_s_a_0_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_s_a_0 " .. filename(), p_s_a_0 )
	p_s_b_0_hotkey_id = obs.obs_hotkey_register_frontend( "p_s_b_0_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_s_b_0 " .. filename(), p_s_b_0 )
	p_s_c_0_hotkey_id = obs.obs_hotkey_register_frontend( "p_s_c_0_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_s_c_0 " .. filename(), p_s_c_0 )
	p_s_d_0_hotkey_id = obs.obs_hotkey_register_frontend( "p_s_d_0_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_s_d_0 " .. filename(), p_s_d_0 )
	p_s_e_0_hotkey_id = obs.obs_hotkey_register_frontend( "p_s_e_0_scoreboard_" .. filename():lower():gsub('[%W%p%c%s]', ''), "p_s_e_0 " .. filename(), p_s_e_0 )				
