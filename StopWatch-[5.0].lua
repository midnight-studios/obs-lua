...
Published / Released: 2023-07-01 21:30
...
local function format_time( timestamp, format )
	...
	if trim and math.abs( current_seconds ) > epsilon then
...
local function cycle_source_list_by_source_type( source_type )
	...
	local count = tablelength( list ); -- use tablelength because this list is a 1-based table
	if cycle_index > count then -- if the current index has higher than available items, start start from 1
		cycle_index = 1;
	end	
...
local function loaded( cd )
	...
	local curent_source_count = count_required_sources()
...
local function property_onchange( props, property, settings )
	...
	obs.obs_property_set_visible( timer_manipulation_prop, layout_value == 2 and timer_options_value == 2 and not in_table( ignore_list, timer_source_value ) );
	obs.obs_property_set_visible( direction_button_prop, layout_value == 2 and enable_direction_toggle and ( timer_mode_value == 2 and countdown_type_value == 2 or timer_mode_value == 1 ) ); --  
	obs.obs_property_set_visible( timer_display_prop, layout_value == 2 and timer_mode_value == 2 and timer_options_value == 2  );
	...
	obs.obs_property_set_visible( split_button_prop, ( timer_mode_value == 1 and not in_table( ignore_list, split_source_value ) ) );
	obs.obs_property_set_visible( text_prefix_prop, layout_value == 2 and timer_options_value == 2 and not in_table( ignore_list, timer_source_value ) );
	obs.obs_property_set_visible( text_suffix_prop, layout_value == 2 and timer_options_value == 2 and not in_table( ignore_list, timer_source_value ) );
	...
	obs.obs_property_set_visible( color_normal_prop, layout_value == 2 and timer_options_value == 2 and not in_table( ignore_list, timer_source_value )  );
	...
	obs.obs_property_set_visible( split_type_prop, timer_mode_value == 1 and not in_table( ignore_list, split_source_value ) and layout_value == 2 and timer_options_value == 2 );
	obs.obs_property_set_visible( split_source_prop, timer_mode_value == 1 and layout_value == 2 and timer_options_value == 2 and not in_table( ignore_list, timer_source_value ) );
	...
	obs.obs_property_set_visible( _group_2_prop, ( layout_value == 2 and timer_options_value == 2 and timer_manipulation == 2 and not in_table( ignore_list, timer_source_value ) ) );
	obs.obs_property_set_visible( _group_3_prop, ( layout_value == 2 and timer_options_value == 2 and timer_manipulation == 2 and not in_table( ignore_list, timer_source_value )  ) );
	--[[
	...
	obs.obs_property_set_visible( hours_prop, layout_value == 2 and timer_mode_value == 2 and timer_options_value == 2  );
	obs.obs_property_set_visible( minutes_prop, layout_value == 2 and timer_mode_value == 2 and timer_options_value == 2  ); 
	obs.obs_property_set_visible( seconds_prop, layout_value == 2 and timer_mode_value == 2 and timer_options_value == 2  ); 
	obs.obs_property_set_visible( next_scene_prop, layout_value == 2 and timer_mode_value == 2 and timer_options_value == 2  );
	obs.obs_property_set_visible( countdown_type_prop, layout_value == 2 and timer_mode_value == 2 and timer_options_value == 2 );
	obs.obs_property_set_visible( start_recording_prop, layout_value == 2 and timer_mode_value == 2 and timer_options_value == 2 );	
	...
	obs.obs_property_set_visible( day_prop, countdown_type_value == 1 and layout_value == 2 and timer_mode_value == 2 and timer_options_value == 2 );
	obs.obs_property_set_visible( year_prop, countdown_type_value == 1 and layout_value == 2 and timer_mode_value == 2 and timer_options_value == 2 );
	obs.obs_property_set_visible( month_prop, countdown_type_value == 1 and layout_value == 2 and timer_mode_value == 2 and timer_options_value == 2 );
	obs.obs_property_set_visible( day_text_prop, countdown_type_value == 1 and layout_value == 2 and timer_mode_value == 2 and timer_format ~= 5 and timer_options_value == 2 );
	obs.obs_property_set_visible( days_text_prop, countdown_type_value == 1 and layout_value == 2 and timer_mode_value == 2 and timer_format ~= 5 and timer_options_value == 2 );
	obs.obs_property_set_visible( cycle_list_prop, ( (next_scene_value == "Source List" or next_scene_value == "Scene List") and timer_mode_value == 2 and layout_value == 2 and timer_options_value == 2 ) );
	obs.obs_property_set_visible( active_source_prop, ( (next_scene_value == "Source List" or next_scene_value == "Scene List") and timer_mode_value == 2 and layout_value == 2 and timer_options_value == 2 ) );
	obs.obs_property_set_visible( as_visible_prop, ( (next_scene_value == "Source List" or next_scene_value == "Scene List") and not in_table( ignore_list, active_source_value ) and timer_mode_value == 2 and layout_value == 2 and timer_options_value == 2 ) );
	obs.obs_property_set_visible( cycle_direction_prop, ( (next_scene_value == "Source List" or next_scene_value == "Scene List") and timer_mode_value == 2 and layout_value == 2 and timer_options_value == 2 ) );
	--[[
	...
	obs.obs_property_set_visible( to_prop, ( layout_value == 2 and not in_table( ignore_list, timer_source_value ) ) );
	obs.obs_property_set_visible( enable_marker_notes_prop, ( layout_value == 2 and trigger_options_value == 2 and ( editable_list_has_values( "text_arr_marker_a" ) or editable_list_has_values( "text_arr_marker_b" ) ) ));
	obs.obs_property_set_visible( text_arr_marker_a_prop, ( layout_value == 2 and trigger_options_value == 2 ) );
	obs.obs_property_set_visible( text_arr_marker_b_prop, ( layout_value == 2 and trigger_options_value == 2 ) );
	obs.obs_property_set_visible( audio_marker_a_prop, ( layout_value == 2 and trigger_options_value == 2 and editable_list_has_values( "text_arr_marker_a" ) ) ); -- text_arr_marker_b  audio_marker_b_arr
	obs.obs_property_set_visible( audio_marker_b_prop, ( layout_value == 2 and trigger_options_value == 2 and editable_list_has_values( "text_arr_marker_b" ) ) );
	obs.obs_property_set_visible( audio_marker_a_arr_prop, ( layout_value == 2 and trigger_options_value == 2 and audio_marker_a_value == 'list' and editable_list_has_values( "text_arr_marker_a" ) ) );
	obs.obs_property_set_visible( audio_marker_b_arr_prop, ( layout_value == 2 and trigger_options_value == 2 and audio_marker_b_value == 'list' and editable_list_has_values( "text_arr_marker_b" ) ) );
	obs.obs_property_set_visible( audio_marker_end_prop, ( in_table( {"TIMER END TEXT", "Select"}, next_scene_value ) and layout_value == 2 and trigger_options_value == 2) );
	obs.obs_property_set_visible( color_marker_a_prop, ( layout_value == 2 and trigger_options_value == 2 and editable_list_has_values( "text_arr_marker_a" ) ) );
	obs.obs_property_set_visible( color_marker_b_prop, ( layout_value == 2 and trigger_options_value == 2 and editable_list_has_values( "text_arr_marker_b" ) ) );
	obs.obs_property_set_visible( media_playback_limit_prop, ( layout_value == 2 and trigger_options_value == 2 ) and ( editable_list_has_values( "text_arr_marker_a" ) or editable_list_has_values( "text_arr_marker_b" ) ) and not ( in_table( {'none'}, audio_marker_a_value ) and in_table( {'none'}, audio_marker_b_value ) )  );
	obs.obs_property_set_visible( duration_marker_a_prop, ( layout_value == 2 and trigger_options_value == 2 and media_playback_limit_value == 2 ) and ( not in_table( {'none'}, audio_marker_a_value ) ) and editable_list_has_values( "text_arr_marker_a" ) );
	obs.obs_property_set_visible( duration_marker_b_prop, ( layout_value == 2 and trigger_options_value == 2 and media_playback_limit_value == 2 ) and ( not in_table( {'none'}, audio_marker_b_value ) ) and editable_list_has_values( "text_arr_marker_b" ) );
	obs.obs_property_set_visible( a_note_prop, ( layout_value == 2 and enable_marker_notes_value ~= 1 and trigger_options_value == 2 and not in_table( ignore_list, note_source_marker_a_value ) and editable_list_has_values( "text_arr_marker_a" ) ) );
	obs.obs_property_set_visible( b_note_prop, ( layout_value == 2 and enable_marker_notes_value ~= 1 and trigger_options_value == 2 and not in_table( ignore_list, note_source_marker_b_value ) and editable_list_has_values( "text_arr_marker_b" ) ) );
	obs.obs_property_set_visible( a_source_prop, ( layout_value == 2 and enable_marker_notes_value ~= 1 and trigger_options_value == 2 and editable_list_has_values( "text_arr_marker_a" ) ) );
	obs.obs_property_set_visible( b_source_prop, ( layout_value == 2 and enable_marker_notes_value ~= 1 and trigger_options_value == 2 and editable_list_has_values( "text_arr_marker_b" ) ) );
	obs.obs_property_set_visible( reset_text_marker_a_prop, ( layout_value == 2 and trigger_options_value == 2 and editable_list_has_values( "text_arr_marker_a" ) ) );
	obs.obs_property_set_visible( reset_text_marker_b_prop, ( layout_value == 2 and trigger_options_value == 2 and editable_list_has_values( "text_arr_marker_b" ) ) );
	obs.obs_property_set_visible( hide_note_marker_a_prop, ( layout_value == 2 and trigger_options_value == 2 and enable_marker_notes_value ~= 1 and not in_table( ignore_list, note_source_marker_a_value ) and editable_list_has_values( "text_arr_marker_a" ) ) );
	obs.obs_property_set_visible( hide_note_marker_b_prop, ( layout_value == 2 and trigger_options_value == 2 and enable_marker_notes_value ~= 1 and not in_table( ignore_list, note_source_marker_b_value ) and editable_list_has_values( "text_arr_marker_b" ) ) );
	obs.obs_property_set_visible( duration_marker_end_prop, ( in_table( {"TIMER END TEXT", "Select"}, next_scene_value ) and layout_value == 2 and trigger_options_value == 2 and media_playback_limit_value == 2 ) );
	--[[
	
			BACKUP SETTINGS INPUTS
	
	]]	
	obs.obs_property_set_visible( debug_enabled_prop, ( layout_value == 2 ));
	obs.obs_property_set_visible( backup_mode_prop, ( layout_value == 2 ));
	obs.obs_property_set_visible( import_list_prop, backup_mode_value and backup_folder ~= "" and backup_folder ~= nil and layout_value == 2 );
	obs.obs_property_set_visible( export_button_prop, backup_mode_value and backup_folder ~= "" and backup_folder ~= nil  and layout_value == 2 );
	obs.obs_property_set_visible( import_button_prop, backup_mode_value and layout_value == 2 );
	obs.obs_property_set_visible( export_folder_prop, backup_mode_value and layout_value == 2 );
	obs.obs_property_set_visible( import_button_prop, import_list_value ~= "select" and import_list_value ~= "none" and import_list_value ~= "" and layout_value == 2 );
	--[[
	...
	obs.obs_property_set_visible( prevent_negative_time_prop, enable_direction_toggle and layout_value == 2 and ( timer_mode_value == 2 and countdown_type_value == 2 or timer_mode_value == 1 ) );
	...
	if property_name == "timer_source" and in_table( ignore_list, timer_source_value ) then
		...
		obs.obs_data_set_int( settings, "timer_manipulation", ( ( timer_manipulation == 2 ) and 1 or 3 )  ); 	
	end
  -- IMPORTANT: returns true to trigger refresh of the properties
  return true;
end
...
function timer_ended( source_name )
	...
	if timer_mode == 2 and timer_display == 2 and in_table( {"select", "Select"}, next_scene ) then 
		local text = "";
		set_text( source_name, text );
	end	
	...
	if timer_mode == 2 and not in_table( {"TIMER END TEXT", "Source List", "Scene List", "Select"}, next_scene ) then
	...
	if timer_mode == 2 and next_scene == "Source List" then
		cycle_source_list( "source" );
	end	
	if timer_mode == 2 and next_scene == "Scene List" then
		cycle_source_list( "scene" );
	end	
	if timer_mode == 2 and next_scene == "TIMER END TEXT" then
		...
		if timer_mode == 2 and in_table( {"TIMER END TEXT", "Select"}, next_scene ) then
			--[[
...
function script_properties()
	...
	local p_37 = obs.obs_properties_add_list( ctx.propsDef, "next_scene", "<i>Timer Expire Event</i>", obs.OBS_COMBO_TYPE_LIST, obs.OBS_COMBO_FORMAT_STRING );
