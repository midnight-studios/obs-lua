...
function config_time( hour, minutes, seconds, mili )
	local format_hour, 
	format_minutes, 
	format_seconds, 
	format_mili = 
...
--------------------------------------------------------------------
	...
	Resinstate timer_format and trim for zeros
--------------------------------------------------------------------
]]
...
--------------------------------------------------------------------
	...
	$function status: NOT IN SERVICE
--------------------------------------------------------------------
]]
function TimeFormat_old( time, notrim )
	if time == nil then
		return
	end
...
function mili_button_clicked( props, p, settings )
	mili_toggle( true )
	return true
end	
