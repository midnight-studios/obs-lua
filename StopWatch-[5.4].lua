...
Published / Released: 2023-10-17 16:31
...
- No bugs reported prior to this release.
...
local function timer_expire_event_cycle_source_list( source_type )
	...
	--timer_active = false
	startpause( true, true ); -- Restart the timer
end
--[[
----------------------------------------------------------------------------------------------------------------------------------------
	Description:	
...
function script_properties()
	...
	obs.obs_properties_add_int( group_props_1, "sw_days_saved", "DD", 0, 7300, 1 );
	obs.obs_properties_add_int( group_props_1, "sw_hours_saved", "HH", 0, 23, 1);
	obs.obs_properties_add_int( group_props_1, "sw_minutes_saved", "MM", 0, 59, 1);
	obs.obs_properties_add_int( group_props_1, "sw_seconds_saved", "SS", 0, 59, 1);
	obs.obs_properties_add_int( group_props_1, "sw_milliseconds_saved", "FF", 0, 99, 1);
	obs.obs_properties_add_bool( group_props_1, "load_saved_time", "Autoload last time stamp when OBS starts" );
	obs.obs_properties_add_button( group_props_1, "sw_button", "Set", sw_saved_button_clicked );
	--[[
		Hidden Value
