...
Version 4.11 (Pre Release) 

Published / Released: 2023-05-24 22:48
...
local function getNextMarkerTime( property_name )
	--[[
...
function update_time_markers()		
	media["text_marker_a"] = getNextMarkerTime( "text_marker_a_arr" )			
	media["text_marker_b"] = getNextMarkerTime( "text_marker_b_arr" );
	--log("text_marker_a", pre_dump(media["text_marker_a"]))
	--log("text_marker_b", pre_dump(media["text_marker_b"]))
end	
--[[
----------------------------------------------------------
...
--[[
----------------------------------------------------------------------------------------------------------------------------------------
	Description:	Function to cycle list items (cycle_property_string_list_items( property_name ))
	
	Credit:			


	Modified:		text_marker_a_arr
...
local function property_onchange( props, property, settings )
	...
	local text_marker_a_arr_prop = obs.obs_properties_get( props, "text_marker_a_arr" );
	local text_marker_b_arr_prop = obs.obs_properties_get( props, "text_marker_b_arr" );
	...
	obs.obs_property_set_visible( text_marker_a_arr_prop, ( config_value == 2 and trigger_options_value == 2 ) );
	obs.obs_property_set_visible( text_marker_b_arr_prop, ( config_value == 2 and trigger_options_value == 2 ) );
...
function script_properties()
	...
	local p_21 = obs.obs_properties_add_editable_list( ctx.propsDef, "text_marker_a_arr", "Marker A Time", obs.OBS_EDITABLE_LIST_TYPE_STRINGS, nil, nil );
	--[[
		 Text Field
	]]	
	...
	local p_22 = obs.obs_properties_add_editable_list( ctx.propsDef, "text_marker_b_arr", "Marker B Time", obs.OBS_EDITABLE_LIST_TYPE_STRINGS, nil, nil );
